...
centos ()
{
  ...
  virt-install -n ubuntu --description "run in console mode" --os-type=Linux --os-variant centos7.0 --ram-2048 --vcpu=2 --disk path="",bus=virtio,size=60 --graphic none --location "/home/anpham/images/ubuntu-18.04.3-desktop-amd64.iso" --extra-args="console=tty0 console=ttyS0,115200" --check all=off 
}
